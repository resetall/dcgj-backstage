...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <link href="assets/plugins/bootstrap-switch/static/stylesheets/bootstrap-switch.css" rel="stylesheet" type="text/css" />
                ...
                <div class="page-sidebar navbar-collapse collapse">
                    ...
                    <ul class="page-sidebar-menu" id="page-sidebar-menu">
                        ...
                        <li class="start active">
                            <a href="backstage/page/dashboard" id="btn-dashboard">
                                <i class="fa fa-home"></i><span class="title"> 首页 </span>
                                <span class="selected"> </span>
                            </a>
                        </li>

                        <!-- 拥有后台管理权限的用户可以进行后台用户操纵 -->
                        ...
                        <li class="">
                            ...
                            <ul class="sub-menu">
                                <li>
                                    <a href="backstage/page/adminUser">
                                        用户管理
                                    </a>
                                </li>
                                <li>
                                    <a href="backstage/page/addAdmin">
                                        添加管理员
                                    </a>
                                </li>
                            </ul>
                        ...
                        <!-- 拥有页面操作权限的可以操作页面 -->
                        <shiro:hasAnyRoles name="superadmin,pagemanager">
                        <li class="">
                            <a href="javascript:;">
                            ...
                            <ul class="sub-menu">
                                <li>
                                    <a href="/backstage/page/indexDesign">
                                        首页管理
                                    </a>
                                </li>
                                <li>
                                    <a href="/backstage/page/pageDesign">
                                        作品案例
                                    </a>
                                </li>
                                <li>
                                    <a href="/backstage/page/newsDesign">
                                        新闻管理
                                    </a>
                                </li>
                                <li>
                        ...
                        <li class="">
                            <a href="javascript:;">
                                <i class="fa fa-user"></i><span class="title"> 客户中心 </span><span
                                class="arrow "> </span>
                            </a>
                            <ul class="sub-menu">
                                <li>
